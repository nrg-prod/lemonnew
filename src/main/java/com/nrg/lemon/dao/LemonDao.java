...
public interface LemonDao
{
	...
	public String insertEmployee(EmployeeDataBean employeeDataBean,String personID, String clientID);

	public List<EmployeeDataBean> getemployeeInfo(String personID,String clientID);

	public List<Employee> emolpoyeeDetails(EmployeeDataBean employeeDataBean,String personID, String clientID);
	...
	public String insertPrinterOrder(String personID, String clientID,ProductionDataBean productionDataBean,
			List<ProductionDataBean> printerorderlist);

	public String insertPrinterRecOrder(String personID, String clientID,ProductionDataBean productionDataBean,
			List<ProductionDataBean> printerorderlist);
	...
	public void updateStocks(int mnaualStockID,String quantity, String motive);
	...
	public String savetable(String personID, String clientID,
			ProductionDataBean productionDataBean);
